...
import { Nebula, ClientOptions } from '@nebula-ai/sdk';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Nebula)`
    : `const run: (${functionSource.client}: Nebula) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.memories.createUpload',
    'client.memories.delete',
    'client.memories.deleteMany',
    'client.memories.deleteUpload',
    ...
    'client.connectors.listProviders',
    'client.connectors.retrieve',
    'client.connectors.sync',
    'client.snapshots.export',
    'client.snapshots.import',
  ],
