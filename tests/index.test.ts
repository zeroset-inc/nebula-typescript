...
import { APIPromise } from 'nebula-typescript/core/api-promise';

import util from 'node:util';
import Nebula from 'nebula-typescript';
import { APIUserAbortError } from 'nebula-typescript';
...
describe('instantiate client', () => {
  ...
  describe('logging', () => {
    ...
    beforeEach(() => {
      process.env = { ...env };
      process.env['NEBULA_LOG'] = undefined;
    });
    ...
    const forceAPIResponseForClient = async (client: Nebula) => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['NEBULA_BASE_URL'] = undefined;
    });
