...
export interface paths {
    ...
    "/v1/ingestion-operations": {
         ...
         * @description Create an open ingestion operation for one collection.
         */
        post: operations["ingestionOperation.create"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/ingestion-operations/search-barrier": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Wait until successful items are visible to memory search.
         */
        post: operations["ingestionOperation.searchBarrier"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/ingestion-operations/status": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Get ordered status views for multiple ingestion operations.
         */
        post: operations["ingestionOperation.getMany"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/ingestion-operations/{operation_id}": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Get per-item ingestion, search, and processing readiness.
         */
        get: operations["ingestionOperation.get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/ingestion-operations/{operation_id}/cancel": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Cancel unfinished items and fence their active generations.
         */
        post: operations["ingestionOperation.cancel"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/ingestion-operations/{operation_id}/items": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Add or replay one memory under a stable client item key.
         */
        put: operations["ingestionOperation.putItem"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/v1/ingestion-operations/{operation_id}/seal": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Seal an operation so its item set cannot change.
         */
        post: operations["ingestionOperation.seal"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /** BatchedOperationStatusRequest */
        BatchedOperationStatusRequest: {
            /**
             * Operations
             * @description Distinct operation selections to retrieve.
             */
            operations: components["schemas"]["IngestionOperationSelection"][];
        };
        /** BatchedOperationStatusResponse */
        BatchedOperationStatusResponse: {
            /**
             * Operations
             * @description Statuses in the request's operation order.
             */
            operations: components["schemas"]["IngestionOperationStatus"][];
        };
        /**
        ...
        /** CreateIngestionOperationRequest */
        CreateIngestionOperationRequest: {
            /**
             * Collection Id
             * Format: uuid
         ...
         * @enum {string}
         */
        IngestionItemOutcome: "processing" | "succeeded" | "failed" | "cancelled";
        ...
        IngestionOperationConflictPublicApiError: {
             ...
             * @enum {string}
             */
            code: "ingestion_operation_conflict";
            /** Details */
            details: null;
            /** Message */
            message: string;
        ...
        /** IngestionOperationFailure */
        IngestionOperationFailure: {
            /** @description Stable machine-readable reason for the terminal result. */
            code: components["schemas"]["IngestionOperationFailureCode"];
            /**
             * Details
        ...
        /**
         * IngestionOperationFailureCode
         * @enum {string}
         */
        IngestionOperationFailureCode: "item_processing_failed" | "operation_cancelled" | "admission_failed" | "memory_deleted" | "generation_superseded" | "ingestion_failed" | "extraction_failed" | "materialization_failed" | "dedup_failed" | "post_dedup_failed" | "composite_failed" | "downstream_mutation_failed" | "stage_cancelled";
        /** IngestionOperationItemCounts */
        IngestionOperationItemCounts: {
            /**
             * Cancelled
             * @description Cancelled items.
             */
            cancelled: number;
            /**
             * Failed
            ...
            /**
             * Processing
             * @description Items still processing.
             */
            processing: number;
            /**
             * Succeeded
            ...
            /**
             * Total
             * @description Total items in the operation.
             */
            total: number;
        };
        /** IngestionOperationItemInput */
        IngestionOperationItemInput: {
            /**
             * Item Key
            ...
            memory: components["schemas"]["StoreMemoryBatchItem"];
        };
        /** IngestionOperationItemReference */
        IngestionOperationItemReference: {
            /**
             * Item Key
             * @description Stable key of the item.
             */
            item_key: string;
            /**
             * Operation Id
             * Format: uuid
             * @description Operation that owns the item.
             */
            operation_id: string;
        };
        /** IngestionOperationItemStatus */
        IngestionOperationItemStatus: {
            /** @description Terminal item failure or cancellation detail, when present. */
            failure?: components["schemas"]["IngestionOperationFailure"] | null;
            /**
             * Fully Processed
             ...
             * Memory Id
             * Format: uuid
             * @description Memory created for this item.
             */
            memory_id: string;
            /** @description Current item outcome. */
            outcome: components["schemas"]["IngestionItemOutcome"];
            ...
            readiness_boundary: components["schemas"]["IngestionReadinessBoundary"];
            /**
             * Required Frontiers
            ...
            stages: components["schemas"]["IngestionOperationStages"];
        };
        /** IngestionOperationSelection */
        IngestionOperationSelection: {
            /**
             * Collection Id
             * Format: uuid
             ...
             * Operation Id
             * Format: uuid
             * @description Operation to inspect or await.
             */
            operation_id: string;
        };
        /** IngestionOperationStages */
        IngestionOperationStages: {
            /** @description Composite formation stage status. */
            composite: components["schemas"]["IngestionStageStatus"];
            /** @description Deduplication stage status. */
            dedup: components["schemas"]["IngestionStageStatus"];
            /** @description Durable handoff from extraction to collection deduplication. */
            dedup_handoff: components["schemas"]["IngestionStageStatus"];
            /** @description Extraction stage status. */
            extraction: components["schemas"]["IngestionStageStatus"];
            /** @description Ingestion stage status. */
            ingestion: components["schemas"]["IngestionStageStatus"];
            /** @description Post-deduplication stage status. */
            post_dedup: components["schemas"]["IngestionStageStatus"];
        };
        /**
         * IngestionOperationState
         * @enum {string}
         */
        IngestionOperationState: "open" | "sealed" | "processing" | "searchable" | "fully_processed" | "failed" | "cancelled";
        ...
        IngestionOperationStatus: {
             ...
             * Collection Id
             * Format: uuid
             * @description Collection that owns the operation.
             */
            collection_id: string;
            ...
            item_counts: components["schemas"]["IngestionOperationItemCounts"];
            /**
             * Items
             * @description Items in stable order within the response scope.
             */
            items: components["schemas"]["IngestionOperationItemStatus"][];
            /**
             * Operation Id
             * Format: uuid
             * @description Stable ingestion operation identifier.
             */
            operation_id: string;
            /** @description Whether state, item_counts, and items describe the full operation or the explicitly requested item selection. */
            scope: components["schemas"]["IngestionOperationStatusScope"];
            /**
             * Sealed
             * @description Whether no additional items may be added.
             */
            sealed: boolean;
            /** @description Projected state within the declared response scope. */
            state: components["schemas"]["IngestionOperationState"];
        };
        /**
         * IngestionOperationStatusScope
         * @enum {string}
         */
        IngestionOperationStatusScope: "operation" | "selection";
        /**
         * IngestionReadinessBoundary
         * @enum {string}
         */
        IngestionReadinessBoundary: "ingestion" | "extraction" | "searchable" | "dedup_handoff" | "dedup" | "post_dedup" | "composite" | "fully_processed";
        /**
         * IngestionResponse
         * @example {
         ...
         * @enum {string}
         */
        IngestionStageState: "pending" | "succeeded" | "queued" | "not_required" | "failed" | "cancelled";
        /** IngestionStageStatus */
        IngestionStageStatus: {
            /** @description Failure recorded when this stage failed. */
            failure?: components["schemas"]["IngestionOperationFailure"] | null;
        ...
        /** SearchBarrierResponse */
        SearchBarrierResponse: {
            /**
             * Failed Items
             * @description Exact terminally failed or cancelled item references.
             */
            failed_items?: components["schemas"]["IngestionOperationItemReference"][];
            /**
             * Operations
             * @description Statuses in the request's operation order.
             */
             ...
             */
            pending_items?: components["schemas"]["IngestionOperationItemReference"][];
            /** @description Result of evaluating the barrier. */
            state: components["schemas"]["SearchBarrierState"];
        };
        /**
         * SearchBarrierState
         * @enum {string}
         */
        SearchBarrierState: "pending" | "satisfied" | "failed";
        /**
         * SearchEffort
        ...
        /** NebulaResults[BatchedOperationStatusResponse] */
        WrappedBatchedOperationStatusResponse: {
            results: components["schemas"]["BatchedOperationStatusResponse"];
        };
        ...
        /** NebulaResults[IngestionOperationStatus] */
        WrappedIngestionOperationStatus: {
            results: components["schemas"]["IngestionOperationStatus"];
        };
        ...
        /** NebulaResults[SearchBarrierResponse] */
        WrappedSearchBarrierResponse: {
            results: components["schemas"]["SearchBarrierResponse"];
        };
...
export interface operations {
    ...
    "ingestionOperation.create": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateIngestionOperationRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            201: {
                ...
                content: {
                     ...
                     *     }
                     */
                    "application/json": components["schemas"]["WrappedIngestionOperationStatus"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    "ingestionOperation.searchBarrier": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["SearchBarrierRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                     ...
                     *     }
                     */
                    "application/json": components["schemas"]["WrappedSearchBarrierResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    "ingestionOperation.getMany": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["BatchedOperationStatusRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
            200: {
                ...
                content: {
                     ...
                     *     }
                     */
                    "application/json": components["schemas"]["WrappedBatchedOperationStatusResponse"];
                };
            };
            /** @description Bad Request */
            400: {
    ...
    "ingestionOperation.putItem": {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["IngestionOperationItemInput"];
            };
        };
        responses: {
            /** @description Successful Response */
