...
export interface paths {
    "/v1/collections": {
        ...
        /**
         * List collections
         * @description Returns a paginated list of collections the authenticated user
         *     has access to.
         *
    ...
    "/v1/collections/name/{collection_name}": {
         ...
         */
        get: operations["retrieve_collection_by_name"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/collections/{id}": {
         ...
         */
        get: operations["retrieve_collection"];
        put?: never;
        /**
         * Update collection
    ...
    "/v1/connectors/providers": {
         ...
         */
        get: operations["list_connector_providers"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/connectors/{connection_id}": {
         ...
         */
        get: operations["retrieve_connector"];
        put?: never;
        post?: never;
        /**
    ...
    "/v1/connectors/{provider}/connect": {
         ...
         */
        post: operations["connect_connector"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/device-memory/snapshot/export": {
         ...
         */
        post: operations["export_snapshot"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/device-memory/snapshot/import": {
         ...
         */
        post: operations["import_snapshot"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/memories": {
        ...
        /**
         * List engrams
         * @description Returns a paginated list of engrams the authenticated user has
         *     access to.
         *
    ...
    "/v1/memories/delete": {
         ...
         */
        post: operations["delete_memories"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/memories/upload": {
         ...
         */
        post: operations["create_memory_upload"];
        /**
         ...
         */
        delete: operations["delete_memory_upload"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/v1/memories/workflow/recall": {
         ...
         */
        post: operations["recall_workflow_patterns"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/memories/{id}": {
         ...
         */
        get: operations["retrieve_memory"];
        put?: never;
        post?: never;
        /**
         * Delete an engram
...
export interface components {
    schemas: {
         ...
         */
        MemoryCreateResponse: components["schemas"]["NebulaResults_MemoryCreateAcceptedResponse_"] | components["schemas"]["NebulaResults_SnapshotMutationResult_"];
        /**
         * MemoryRecall
        ...
        /**
         * WrappedEngramsResponse
         * @description Paginated /v1/memories list response.
         *
    ...
    list_collections: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["PaginatedNebulaResult_list_CollectionResponse__"];
                };
            };
    ...
    create_collection: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_CollectionResponse_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    delete_collection: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_GenericBooleanResponse_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    list_connectors: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_list_ConnectorConnectionResponse__"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    list_connector_providers: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_list_str__"];
                };
            };
        };
    };
    retrieve_connector: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_ConnectorConnectionResponse_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    disconnect_connector: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_ConnectorDisconnectResponse_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    sync_connector: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_ConnectorSyncResponse_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    connect_connector: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_ConnectorConnectResponse_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    export_snapshot: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_SnapshotEnvelope_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    import_snapshot: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_SnapshotImportResult_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    health_check: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_GenericMessageResponse_"];
                };
            };
        };
    };
    list_memories: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["WrappedEngramsResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    delete_memories: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_GenericBooleanResponse_"] | components["schemas"]["BatchDeleteResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    search_memories: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_CompactMemoryRecallResponse_"] | components["schemas"]["NebulaResults_MemoryRecall_"] | components["schemas"]["NebulaResults_SnapshotSearchResult_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    create_memory_upload: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_PresignedUploadResponse_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    retrieve_memory: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_Engram_"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    append_memory: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["NebulaResults_AppendMemoryResponse_"] | components["schemas"]["NebulaResults_IngestionResponse_"];
                };
            };
            /** @description Validation Error */
            422: {
