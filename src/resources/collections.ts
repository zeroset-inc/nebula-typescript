...
export class CollectionsResource {
  ...
  ): Promise<components["schemas"]["NebulaResults_CollectionResponse_"]> {
    return this.core.request<components["schemas"]["NebulaResults_CollectionResponse_"]>({
      method: "POST",
      path: "/v1/collections",
      pathParams: {},
      query: undefined,
  ...
  workspaceId?: string | null;
    ...
    options?: RequestOptions,
  ): Promise<components["schemas"]["PaginatedNebulaResult_list_CollectionResponse__"]> {
    return this.core.request<components["schemas"]["PaginatedNebulaResult_list_CollectionResponse__"]>({
      method: "GET",
      path: "/v1/collections",
      pathParams: {},
      query: { ids: params.ids, name: params.name, offset: params.offset, limit: params.limit, owner_only: params.ownerOnly, workspace_id: params.workspaceId },
      idempotent: true,
      signal: options?.signal,
    });
  }
